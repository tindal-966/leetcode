...
class Solution {
    public int removeElement(int[] nums, int val) {
        ...
        while (pivot < length && pivotDynamic < length) {
            int value = nums[pivotDynamic];

            if (value == val) {
                // find the first no-equal value
                while (pivotDynamic < length && nums[pivotDynamic] == val) {
                    pivotDynamic++;
                }
            }

            if (pivotDynamic < length && pivotDynamic != pivot) {
                nums[pivot] = nums[pivotDynamic];
            }
        ...
        return length - (pivotDynamic - pivot);
    }
}
